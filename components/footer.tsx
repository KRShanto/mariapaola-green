...
export default function Footer() {
  ...
  return (
    <footer id="contact-information-footer" className="bg-secondary-900 text-text-light py-12">
        ...
        <div className="grid md:grid-cols-4 gap-8">
          <FadeIn delay={0.1}>
            <div>
              ...
              <p className="text-secondary-400">
                Helping businesses grow through strategic LinkedIn optimization and digital marketing.
              </p>
            </div>
          </FadeIn>
          ...
          <FadeIn delay={0.3}>
            <div>
              ...
              <ul className="space-y-2 text-secondary-400">
                <li>
                  <i className="fa-regular fa-envelope mr-2"></i> contact@mpgvaservices.com
                </li>
                <li>
